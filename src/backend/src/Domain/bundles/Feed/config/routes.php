...
return [
    'common' => [
        ...
        [
            'type' => 'route',
            'method' => 'post',
            'url' => '/feed/get/{command:personal-themes}[/]',
            'middleware' => FeedMiddleware::class,
        ...
        [
            'type' => 'route',
            'method' => 'post',
            'url' => '/feed/get/{command:personal-communities}[/]',
            'middleware' => FeedMiddleware::class,
        ...
        [
            'type' => 'route',
            'method' => 'post',
            'url' => '/feed/get/{command:personal-collections}[/]',
            'middleware' => FeedMiddleware::class,
        ...
        [
            'type' => 'route',
            'method' => 'post',
            'url' => '/feed/get/{command:personal-people}[/]',
            'middleware' => FeedMiddleware::class,
