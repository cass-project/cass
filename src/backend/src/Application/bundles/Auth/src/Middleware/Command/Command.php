...
use Application\Auth\Middleware\Command\OAuth\BattleNetCommand;
use Application\Auth\Middleware\Command\OAuth\FacebookCommand;
use Application\Auth\Middleware\Command\OAuth\GoogleCommand;
use Application\Auth\Middleware\Command\OAuth\MailruCommand;
use Application\Auth\Middleware\Command\OAuth\OdnoklassnikiCommand;
use Application\Auth\Middleware\Command\OAuth\VkCommand;
use Application\Auth\Middleware\Command\OAuth\YandexCommand;
