<?php
namespace Application\Post\Repository;

use Application\Collection\Entity\Collection;
use Doctrine\ORM\AbstractQuery;
use Doctrine\ORM\EntityRepository;
use Application\Feed\Feed\Criteria\SeekCriteria;
...
{
    // TODO: Validation: Application\Collection is owned by profile
    ...
    public function getPost(int $postId): Post {
        ...
        if($post === null) {
            throw new PostNotFoundException(sprintf('Application\Post with id `%d` not found', $postId));
        }
