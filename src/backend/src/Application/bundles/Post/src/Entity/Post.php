<?php
namespace Application\Post\Entity;

use Application\Collection\Entity\Collection;
use Application\Profile\Entity\Profile;

/**
 * @Entity(repositoryClass="Application\Post\Repository\PostRepository")
 * @Table(name="post")
 */
class Post
{
    ...
    /**
     * @ManyToOne(targetEntity="Application\Collection\Entity\Application\Collection")
