<?php
namespace Application\Feed\Feed\Criteria;

use Application\Feed\Exception\Criteria\SeekInvalidOffsetException;
use Application\Feed\Exception\Criteria\SeekLimitBoundException;
