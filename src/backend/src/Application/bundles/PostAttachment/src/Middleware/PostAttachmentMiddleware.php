<?php
namespace Application\PostAttachment\Middleware;

use Application\Auth\Service\CurrentAccountService;
use Application\Common\REST\GenericRESTResponseBuilder;
use Application\PostAttachment\Exception\PostAttachmentFactoryException;
use Application\PostAttachment\Middleware\Command\Command;
