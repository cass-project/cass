...
/**
 * @Entity(repositoryClass="Application\Profile\Repository\ProfileImageRepository")
...
class ProfileImage implements JSONSerializable
{
    ...
    /**
     * @OneToOne(targetEntity="Application\Profile\Entity\Application\Profile", inversedBy="profileImage")
