...
/**
 * @Entity(repositoryClass="Application\Profile\Repository\ProfileGreetingsRepository")
...
class ProfileGreetings implements JSONSerializable
{
    ...
    /**
     * @OneToOne(targetEntity="Application\Profile\Entity\Application\Profile", inversedBy="profileGreetings")
