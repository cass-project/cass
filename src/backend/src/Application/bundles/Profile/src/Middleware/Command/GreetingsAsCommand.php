...
use Application\Profile\Middleware\Request\GreetingsFLRequest;
use Application\Profile\Middleware\Request\GreetingsLFMRequest;
use Application\Profile\Middleware\Request\GreetingsNRequest;
