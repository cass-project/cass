<?php
namespace Application\Collection\Repository;
...
use Application\Collection\Service\Parameters\CollectionService\CollectionParameters;
...
class CollectionRepository extends EntityRepository
{
    ...
    public function getCollectionEntity(int $id): Collection
    {
        ...
        if ($collectionEntity === null) {
            throw new DataEntityNotFoundException(sprintf("Application\Theme Entity with ID `%d` not found", $id));
        }
        return $collectionEntity;
    }
}